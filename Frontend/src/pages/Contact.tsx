          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-10">
              ...
              <div className={`space-y-5 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '200ms' }}>
                ...
                {/* Clinic Hours Table */}
                <div className="bg-white rounded-3xl p-5 shadow-soft border border-mint/15">
                ...
                {/* Emergency Note */}
                <div className="bg-amber-50 rounded-3xl p-5 border border-amber-200/50 flex items-start gap-3">
              ...
              <div className={`space-y-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '400ms' }}>
                {/* Contact Form */}
                <div className="bg-white rounded-3xl p-6 shadow-soft border border-mint/15">
                ...
                {/* Map */}
                <div className="rounded-3xl overflow-hidden shadow-soft border border-mint/15 h-64">
                  <iframe
